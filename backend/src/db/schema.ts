...
export const projects = pgTable('projects', {
  ...
  projectType: text('project_type').default('token_launch'),
  tokenName: text('token_name').default(''),
  tokenSymbol: text('token_symbol').default(''),
  totalSupply: decimal('total_supply', { precision: 20, scale: 7 }).default('1000000'),
  decimals: integer('decimals').default(7).notNull(),
  description: text('description').default(''),
  logoUrl: text('logo_url'),
  airdropPercent: decimal('airdrop_percent', { precision: 5, scale: 2 }).default('20'),
  liquidityPercent: decimal('liquidity_percent', { precision: 5, scale: 2 }).default('20'),
  creatorPercent: decimal('creator_percent', { precision: 5, scale: 2 }).default('60'),
  initialLiquidityXLM: decimal('initial_liquidity_xlm', { precision: 20, scale: 7 }).default('1000'),
  eventDurationDays: integer('event_duration_days').default(7),
  eventStartDate: timestamp('event_start_date').defaultNow().notNull(),
